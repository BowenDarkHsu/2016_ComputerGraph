...
void* RobotArm::DrawPosition&(void) {
...
void* RobotArm::X_DirectionMenuFunc(int id) {
	switch (id) {
	case 1:		// Increase 
...
void* RobotArm::Y_DirectionMenuFunc(int id) {
	switch (id) {
	case 1:		// Increase 
...
void* RobotArm::ArmRotationMenuFunc(int id) {
	switch (id) {
	case 1:		// Clockwise 
...
void* RobotArm::GripperHeightMenuFunc(int id) {
	switch (id) {
	case 1:		// Up 
...
void* RobotArm::GripperControlMenuFunc(int id) {
	switch (id) {
	case 1:		// Open 
...
void* RobotArm::DrawRobotArm(void) {
...
void* RobotArm::DrawCube(float Length, float Height, float Width) {
